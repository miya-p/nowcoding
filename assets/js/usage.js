...
$(document).ready(function(){
    ...
    /* HEADER ALARM */
    $('#bell').click(function() {
        $('.tooltip.alarm').toggle(100, function(){
            if ($(".tooltip.alarm").is(":visible")){
                $('.tooltip-bg').css("display", "block");
            }else{
                $('.tooltip-bg').css("display", "none");
                $('.alarmArea').animate({
                    left: '0px'
                },100);
                $('.followRequestArea').animate({
                    left: '380px'
                },100);
            }
        });
	...
	$(".tooltip-bg").click(function(){
		if ($(this).is(":visible")){
			...
			$('.tooltip.alarm').css("display", "none");
		}else{
			//nothing
		}
	});
    ...
    var btnLogin = $(".memlog.out, .m_btnlogin");
    var popBg = $(".popupBg.member");
    var btnClose = $(".btn-pop-close, .btnjoin4");
    var popView = $(".pop-wp");
    ...
    $(".btnjoin").click(function(){
        popView.css('display', 'none');
        $(".joinArea.step1").css('display', 'block');
    });

    $(".btnjoin2").click(function(){
        popView.css('display', 'none');
        $(".joinArea.step2").css('display', 'block');
    });

    $(".btnjoin3").click(function(){
        popView.css('display', 'none');
        $(".joinArea.step3").css('display', 'block');
    });

    $(".btnfindid").click(function(){
        popView.css('display', 'none');
        $(".findArea.step1").css('display', 'block');
    });

    $(".btnfindid2").click(function(){
        popView.css('display', 'none');
        $(".findArea.step2").css('display', 'block');
    });

    $(".btnfindpw").click(function(){
        popView.css('display', 'none');
        $(".findArea.step3").css('display', 'block');
    });

    $(".btnfindpw2").click(function(){
        popView.css('display', 'none');
        $(".findArea.step4").css('display', 'block');
    });
